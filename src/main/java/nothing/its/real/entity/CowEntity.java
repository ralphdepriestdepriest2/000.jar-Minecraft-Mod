...
import nothing.its.real.procedures.ChickenEntityIsHurtProcedure;
...
public class CowEntity extends PathfinderMob {
	public CowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(Ashes1ashesModEntities.COW.get(), world);
	}
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		ChickenEntityIsHurtProcedure.execute(world, x, y, z, entity);
