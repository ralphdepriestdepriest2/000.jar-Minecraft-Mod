...
public class Spawn3Entity extends PathfinderMob {
	public Spawn3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(Ashes1ashesModEntities.SPAWN_3.get(), world);
	}

	public Spawn3Entity(EntityType<Spawn3Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(true);
