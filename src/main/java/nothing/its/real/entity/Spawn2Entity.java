...
public class Spawn2Entity extends PathfinderMob {
	public Spawn2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(Ashes1ashesModEntities.SPAWN_2.get(), world);
	}

	public Spawn2Entity(EntityType<Spawn2Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(true);
