...
public class MazeEntity extends PathfinderMob {
	public MazeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(Ashes1ashesModEntities.MAZE.get(), world);
	}

	public MazeEntity(EntityType<MazeEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(true);
